...
#include "../src/lab_m1/tema2/camera.h"
    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            up = glm::normalize(glm::vec3(rotation * glm::vec4(up, 0.0)));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 rotation = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(rotation));

            rotation = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
        ...
        void SetProjectionMatrix(glm::mat4 newProjection)
        {
